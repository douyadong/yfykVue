        ...
        <?php } ?>
        <?php if($confs["extra_javascripts"]) { ?><script data-main="<?php echo STATIC_DOMAIN . '/' . MODULE_NAME; ?>/js/<?php echo $router["controller"] ; ?>/<?php echo $router["method"] ; ?>.min.js" src="<?php echo STATIC_DOMAIN ; ?>/fe_public_library/wkzf/js/require.min.js"></script>  <?php } ?>      
    </body>
</html>